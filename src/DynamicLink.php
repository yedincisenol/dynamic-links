...
class DynamicLink implements \JsonSerializable
{
     ...
     */
    public function __construct($link, $prefix = null, $androidInfo = null, $iosInfo = null,
                                $enforceRedirectUpdate = false, $analyticsInfo = null, $socialMediaTagInfo = null)
    {
        ...
        $this->setDomainUriPrefix($prefix);
    }
     ...
     * @return $this
     */
    public function setDomainUriPrefix($prefix)
    {
        $this->domainUriPrefix = $prefix;
